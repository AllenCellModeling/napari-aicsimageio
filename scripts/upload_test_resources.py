...
from napari_aicsimageio import __version__
...
def upload_test_resources(args: Args):
    ...
    try:
        ...
        package_name = "napari_aicsimageio/test_resources"
        ...
        # Upload
            ...
            if confirmation:
                pushed = package.push(
                    ...
                    message=(
                        f"Test resources for `napari_aicsimageio` "
                ...
                with open(
                    Path(__file__).parent / "TEST_RESOURCES_HASH.txt", "w"
                ) as open_f:
                    open_f.write(pushed.top_hash)
